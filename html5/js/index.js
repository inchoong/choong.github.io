    ...
    elements_group.innerHTML = '<div class="dashed-circle"></div>\
                                ...
                                <div class="info-panel">\
                                    ...
                                    <div class="info-content">\
                                        <div>\
                                            地点：<span class="risk-city">' + options.city + '</span>\
                                        </div>\
                                        <div>\
                                            计数：<span class="risk-num">' + options.total + '</span>\
                                        </div>\
                                    </div>\
                                </div>';
...
radar.addRiskPoints([
    {
        ...
        type: 'type1',
        severity: 'ordinary',
        coords: [114.057865, 22.543096], // 深圳
        city: '深圳',
        title: '世界地图足迹',
        total: 3
    }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [120.155070, 30.274084], // 浙江·杭州
        city: '杭州', 
        title: '世界地图足迹',
        total: 10
     }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [120.699362, 27.993828], // 浙江·温州
        city: '温州', 
        title: '世界地图足迹',
        total: 1
    }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [114.305393, 30.593099], // 湖北·武汉
        city: '武汉', 
        title: '世界地图足迹',
        total: 10
     }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [112.938814,  28.228209], // 湖南·长沙
        city: '长沙', 
        title: '世界地图足迹',
        total: 0
     }, {
       type: 'type2',
        severity: 'ordinary',
        coords: [118.796877, 32.060255], // 江苏·南京
        city: '南京', 
        title: '世界地图足迹',
        total: 3
     }, {
       type: 'type2',
        severity: 'ordinary',
        coords: [120.58529, 31.298979], // 江苏·苏州
        city: '苏州', 
        title: '世界地图足迹',
        total: 2
     }, {
       type: 'type2',
        severity: 'ordinary',
        coords: [120.31191, 31.49117], // 江苏·无锡
        city: '无锡', 
        title: '世界地图足迹',
        total: 1
     }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [106.912251, 29.431586], // 重庆
        city: '重庆', 
        title: '世界地图足迹',
        total: 0
     }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [104.066801, 30.572816], // 四川·成都
        city: '成都',
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [119.296494, 26.074508], // 福建·福州
        city: '福州',
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [108.93977, 34.341575], // 陕西·西安
        city: '西安',
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [114.5852447, 29.0278558], // 江西·九江
        city: '九江',
        title: '世界地图足迹',
        total: 1
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [117.227219, 31.820592], // 安徽·合肥
        city: '合肥',
        title: '世界地图足迹',
        total: 1
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [112.548879,  37.87059], // 山西·太原
        city: '太原', 
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [123.431472,  41.805699], // 辽宁·沈阳
        city: '沈阳', 
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [118.089425,  24.479834], // 福建·厦门
        city: '厦门', 
        title: '世界地图足迹',
        total: 1
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [120.3348518,  36.0637992], // 山东·青岛
        city: '青岛', 
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [118.356414,  35.104674], // 山东·临沂
        city: '临沂', 
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [117.200983,  39.084158], // 天津
        city: '天津',  
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [113.576678,  22.270978], // 广东·珠海
        city: '珠海', 
        title: '世界地图足迹',
        total: 0
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [113.724865,  22.9796586], // 广东·东莞
        city: '东莞', 
        title: '世界地图足迹',
        total: 2
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [113.121436,  23.021479], // 广东·佛山
        city: '佛山', 
        title: '世界地图足迹',
        total: 2
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [113.392725,  22.516999], // 广东·中山
        city: '中山', 
        title: '世界地图足迹',
        total: 3
 }, {
        type: 'type2',
        severity: 'ordinary',
        coords: [114.109497, 22.396428], // 香港
        city: '香港',
        title: '世界地图足迹',
        total: 0
    }
]);
  // 【coords区位代码参考】https://github.com/vuejs/cn.vuejs.org/blob/master/src/v2/guide/team.md 
  // 【coords区位代码参考】https://github.com/donnemartin/viz/blob/master/githubstats/data/2015/user-geocodes-dump.csv
